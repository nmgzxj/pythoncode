...
page_num=10 
url='http://tieba.baidu.com/f?ie=utf-8&kw=%E4%B8%B4%E6%B2%82&fr=search'
...
file_tieba=open('linyi.csv','w+',encoding='utf-8')
for i in range(1,page_num):
    url_everypage=url+'&pn='+str((i-1)*50)
    print('Processing page:'+url+'&pn='+str(i)+'/'+str(page_num-1)+'......')
